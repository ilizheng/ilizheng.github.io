...
### Journal Papers
1. _A parallel domain decomposition method for the fully-mixed Stokes-dual-permeability fluid flow model with Beavers-Joseph interface conditions_, COMMUN COMPUT PHYS 36 (2024): 551--580. [DOI](https://doi.org/10.4208/cicp.OA-2023-0258) <!-- CiteScore（Q1), JIF(Q1), JCI(Q1), 中科院SCI分区（一区）, 中国数学会(T1) -->
